...
export default function WalletIndex({ balances, wallets, recentTransactions }: Props) {
  ...
  const copyVirtualAccountDetails = (field: string, value: string) => {
                          ...
                          <div className="space-y-4">
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    <Button
                                      ...
                                      size="sm"
                                      className="h-6 w-6 p-0"
                                      onClick={() => copyVirtualAccountDetails('name', virtualAccount.account_name)}
                                    >
                                      <IconCopy className="h-3 w-3" />
                                    </Button>
                                  </div>
                                ...
                                <div>
                                  ...
                                  <div className="flex items-center gap-2">
                                    ...
                                    <Button
                                      ...
                                      size="sm"
                                      className="h-6 w-6 p-0"
                                      onClick={() => copyVirtualAccountDetails('number', virtualAccount.account_number)}
                                    >
                                      <IconCopy className="h-3 w-3" />
                                    </Button>
                                  </div>
                            ...
                            <Alert className="border-emerald-200 bg-emerald-100">
                              ...
                              <AlertDescription className="text-emerald-800">
                                <strong>Instant Transfer:</strong> Transfer any amount to this account. Funds appear instantly!
                              </AlertDescription>
                            </Alert>
                            <Button 
                              className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-semibold py-6 shadow-lg shadow-emerald-600/20"
                              onClick={() => {
                                navigator.clipboard.writeText(`${virtualAccount.account_name}\n${virtualAccount.bank_name}\n${virtualAccount.account_number}`);
                                // Show success message
                              }}
                            >
